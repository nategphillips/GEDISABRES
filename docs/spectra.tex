...
For the $B~^3\Sigma_u^-\!\leftarrow\!X~^3\Sigma_g^-$ transition, the selection rules for the vibrational quantum number are not strictly defined (see Herzberg pg. 151) \cite{herzberg:diatomic}.
...
\begin{equation}
    \Delta{}J = \pm 1
\end{equation}
since both electronic states have $\Lambda = 0$ (see Herzberg pg. 169) \cite{herzberg:diatomic}.
...
\begin{table}[H]
    \centering
    \caption{Notation \cite{herzberg:diatomic,nist:sigma1,nist:sigma3}.}
    \label{t:notation}
    \begin{tabular}{clc}
        \toprule
